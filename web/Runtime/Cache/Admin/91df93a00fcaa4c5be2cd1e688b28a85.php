        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" action="/admin/auth/addrule" method="post">
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                            <?php if(is_array($result)): foreach($result as $key=>$k): ?><tr>
                                <td>
                                    <?php echo ($k["id"]); ?>
                                </td>
                                <td><?php echo ($k["html"]); echo ($k["title"]); ?></td>
                                <td><?php echo ($k["name"]); ?></td>
                                <td><?php echo (date("y-m-d H:i",$k["create_time"])); ?></td>
                                <td>
                                    <a class="popup-with-form btn btn-info" href="#demo-form" onclick="auth_edit(<?php echo ($k["id"]); ?>)">
                                        <i class="fa fa-edit ">&nbsp;编辑</i>
                                    </a>
                                    <!-- Form -->
                                    <form id="demo-form" class="white-popup-block mfp-hide form-horizontal" method="post" action="<?php echo U('Auth/editRule');?>">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-9 col-sm-offset-3">
                                                <div class="pull-right bk-margin-right-15">
                                                    <input type="hidden" value="<?php echo ($k["id"]); ?>" name="rid">
