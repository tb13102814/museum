...
<div class="main ">
    ...
    <div class="row">
        <div class="col-lg-11 col-md-6 col-sm-6 col-xs-12">
            <form id="form" action="<?php echo U('Auth/addGroup');?>" class="form-horizontal" method="POST">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h6><i class="fa  fa-check-circle-o bk-fg-warning"></i>添加用户组</h6>
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="title" class="form-control" title="Plase enter a name." placeholder="eg.: John Smith Doe" required/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="rule_all">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">授权 <span class="required">*</span></label>
                            <div class="col-sm-9">
                        ...
                        <?php if(is_array($res)): foreach($res as $key=>$a): ?><div class="rule_father">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class="checkbox-custom checkbox-inline">
                                        <input type="checkbox" id="check_father" name="check_rule[]" value="<?php echo ($a["id"]); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>     ┠—</b>
                                    <?php if(is_array($a["child"])): foreach($a["child"] as $key=>$b): ?><div class="checkbox-custom checkbox-inline">
                                            <input type="checkbox" id="check_child" name="check_rule[]" value="<?php echo ($b["id"]); ?>">
