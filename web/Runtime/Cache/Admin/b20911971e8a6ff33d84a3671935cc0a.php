            ...
            <div class="col-lg-12">
                <div class="panel panel-default bk-bg-white">
                    <div class="panel-heading bk-bg-white">
                        <h6><i class="fa fa-table"></i><span class="break"></span>用户组列表</h6>
                    ...
                    <div class="panel-body">
                        <a href="<?php echo U('Auth/addGroup');?>">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                                ...
                                <tbody>
                                <?php if(is_array($group)): foreach($group as $key=>$v): ?><tr id="tr_<?php echo ($v["id"]); ?>">
                                        <td>
                                            <div class="checkbox-custom checkbox-success">
                                        ...
                                        <td style="width: 30%">
                                            <a class="btn btn-info" href="<?php echo U('Auth/editGroup',array('id'=>$v['id']));?>">
                                                <i class="fa fa-edit"> 授权/编辑</i>
                                            </a>
                                            <a class="btn btn-success" href="<?php echo U('Auth/editGroup');?>">
