...
<div class="main ">
    ...
    <div class="row">
        <div class="col-lg-11 col-md-6 col-sm-6 col-xs-12">
            <form id="form" action="<?php echo U('Auth/editAdmin');?>" class="form-horizontal" method="post">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h6><i class="fa  fa-check-circle-o bk-fg-warning"></i>修改管理员</h6>
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="fullname" class="form-control" title="Plase enter a name." placeholder="<?php echo ($user['adminor']); ?>" required/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">密码 <span class="required">*</span></label>
                            <div class="col-sm-9">
                                <input type="password" name="password" title="Please enter a password." class="form-control" placeholder="<?php echo ($user['password']); ?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="file-input">头像 <span class="required">*</span></label>
                            <div class="col-md-9">
                                <input type="file" id="file-input" name="file-input">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">所属用户组 <span class="required">*</span></label>
                            <div class="col-md-9">
                                <?php if(is_array($group)): foreach($group as $key=>$v): ?><div class="checkbox-custom checkbox-inline">
                                        <input type="checkbox" id="inline-checkbox1" name="role_id[]" value="<?php echo ($v["id"]); ?>" <?php if($v['is_checked'] == 0): ?>checked="checked"<?php endif; ?>>
                                        <label for="inline-checkbox1"><?php echo ($v["title"]); ?></label>
