            ...
            <div class="col-lg-12">
                <div class="panel panel-default bk-bg-white">
                    ...
                    <div class="panel-body">
                        <a href="<?php echo U('Auth/addAdmin');?>">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                                ...
                                <tbody>
                                <?php if(is_array($adminor)): foreach($adminor as $key=>$v): ?><tr id="tr_<?php echo ($v["id"]); ?>">
                                        <td>
                                            <div class="checkbox-custom checkbox-success">
                                                <input id="checkboxExample3" checked="" type="checkbox">
                                                <label for="checkboxExample3"></label>
                                        ...
                                        <td><?php echo ($v["id"]); ?></td>
                                        <td><?php echo ($v["adminor"]); ?></td>
                                        <td><?php echo ($v["img"]); ?></td>
                                        <td>
                                            <ul>
                                                <?php if($v['adminor'] == C('ADMIN_AUTH_KEY')): ?><b>超级管理员</b>
                                                    <?php else: ?>
                                                    <?php if(is_array($v["auth_group"])): foreach($v["auth_group"] as $key=>$value): ?><li><?php echo ($value["title"]); ?></li><?php endforeach; endif; endif; ?>
                                            </ul>
                                        </td>
                                        <td><?php echo (date('y-m-d H:i',$v["reg_time"])); ?></td>
                                        <td><?php echo ($v["login_ip"]); ?></td>
                                        <?php if($v['last_login_time'] == ''): ?><td>用户还未曾登陆</td>
                                            <?php else: ?>
                                            <td><?php echo (date('y-m-d H:i',$v["last_login_time"])); ?></td><?php endif; ?>
                                        ...
                                        <?php if($v['adminor'] == C('ADMIN_AUTH_KEY')): ?><td>超级管理员无需操作</td>
                                            <?php else: ?>
                                            <td>
                                                <a class="btn btn-info" href="<?php echo U('Auth/editAdmin',array('id'=>$v['id']));?>">
                                                    <i class="fa fa-edit "></i>
                                                </a>
                                                <a class="btn btn-success" href="table.html#">
                                                    <i class="fa fa-search-plus "></i>
                                                </a>
                                                <a class="bk-margin-top-10 bk-margin-bottom-10 modal-basic btn btn-danger" href="#modalPrimary" onclick="del(<?php echo ($v['id']); ?>)"><i class="fa fa-trash-o "></i></a>
