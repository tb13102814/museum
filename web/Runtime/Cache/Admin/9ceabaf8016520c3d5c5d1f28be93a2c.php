...
<div class="main ">
    ...
    <div class="row">
        <div class="col-lg-11 col-md-6 col-sm-6 col-xs-12">
            <form id="form" action="/admin/auth/editgroup/id/8" class="form-horizontal" method="post">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="groupname" class="form-control" placeholder="eg.: John Smith Doe" value="<?php echo ($user_group[0]['title']); ?>" required/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <?php if(is_array($res)): foreach($res as $key=>$a): ?><div class="rule_father">
                        <div class="form-group">
                            <label class="col-sm-3 control-label"><span class="required"></span></label>
                            <div class="col-sm-9">
                                <div class="checkbox-custom checkbox-inline">
                                    <input type="checkbox" id="check_father" name="check_rule[]" value="<?php echo ($a["id"]); ?>" <?php if($a['is_checked']): ?>checked="checked"<?php endif; ?>>
                                    <label for="check_father"><?php echo ($a["title"]); ?></label>
                                </div>
                                <label class="error" for="for[]"></label>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>     ┠—</b>
                                <?php if(is_array($a["child"])): foreach($a["child"] as $key=>$b): ?><div class="checkbox-custom checkbox-inline">
                                    <input type="checkbox" id="check_child" name="check_rule[]" value="<?php echo ($b["id"]); ?>" <?php if($b['is_checked']): ?>checked="checked"<?php endif; ?>>
                                    <label for="check_child"><?php echo ($b["title"]); ?></label>
                        ...
                        <div class="row">
                            <div class="col-sm-9 col-sm-offset-3">
                                <input type="hidden" value="<?php echo ($user_group[0]['id']); ?>" name="gid">
