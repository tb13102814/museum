    ...
    <div class="container">
        <div class="blog-top">
            <div class="col-md-9 blog-left">
                <div class="blog-main">
                    <a class="bg"><?php echo ($result["title"]); ?></a>
                    <p>Post by <a href="#"><?php echo ($result["author"]); ?></a> 20<?php echo (date('y-m-d',$result["create_time"])); ?>  <a href="#">5 comments</a></p>
                </div>
                <div class="blog-main-one">
                    <div class="blog-one blog-sng">
                        <img src="/Public/Uploads/<?php echo ($result["icon"]); ?>" alt="" />
                        <p class="sngl"><?php echo ($result["introduce"]); ?></p>
                    </div>
		...
		<?php if(is_array($comment)): foreach($comment as $key=>$v): ?><div class="comment-list">
                    <h5><a href="#"><?php echo ($v["username"]); ?></a></h5>
                    <div class="cmt-list">
                        <div class="cmt-left">
                            <img src="/Public/Uploads/<?php echo ($v["img"]); ?>" alt="" width="80px" height="80px"/>
                        </div>
                        <div class="cmt-right">
			...
			<p style="font-size: 1.4ch;"><span><?php echo ($v["cid"]); ?>楼</span>&nbsp;<span>20<?php echo (date('y-m-d H:i',$v["replay_time"])); ?></span>&nbsp;&nbsp;&nbsp;<em><a onclick="clickdown(<?php echo ($v["id"]); ?>)"><img src="/Public/Index/images/like.png"/>&nbsp;(<span id="dianzan_<?php echo ($v["id"]); ?>"><?php echo ($v["clicknum"]); ?></span>)</a>&nbsp;&nbsp;&nbsp;<a onclick="replay(<?php echo ($v["aid"]); ?>)"><img src="/Public/Index/images/add.png"/>&nbsp;回复</a>&nbsp;&nbsp;&nbsp;<a onclick="watch(<?php echo ($v["aid"]); ?>,<?php echo ($v["cid"]); ?>)"><img src="/Public/Index/images/link.png"/>&nbsp;查看回复(200)</a></em></p>
			    ...
			    <input type="hidden" value="<?php echo ($result["id"]); ?>" name="aid" id="aid"/>
...
<script type="text/javascript">
    function watch(aid,cid){
	         layer.open({
		           ...
		           maxmin: true,
			   title: '查看全部回复',
		          content: '<?php echo U("Appreciate/watch");?>?aid='+aid+'&cid='+cid,							     });
    }
    function replay(id){
	          layer.open({
		           type: 2,
			   ...
			   fixed: false, //不固定
		           maxmin: true,
		           title: '回复',
		          content: '<?php echo U("Appreciate/replay");?>?aid='+id
		   });
   }
   function clickdown(id){
        $.ajax({
            url:"<?php echo U('Appreciate/clicknum');?>",
            data:{id:id},
            dtattype:"json",
            type:"post",
    ...
    $('document').ready(function(){
	  ...
	  var comment=$('#comment').val();
          if(comment==''){
		   ...
		   $.ajax({
			  url:"<?php echo U('Appreciate/replay');?>",
