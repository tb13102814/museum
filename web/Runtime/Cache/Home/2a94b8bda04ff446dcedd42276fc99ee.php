...
<div class="banner">
    <div class="container">
        <div class="banner-top">
            ...
            <h1>欢迎走进万维虚拟博物馆</h1>
            <ul>
                <li><a class="sub" href="<?php echo U('Display/index',array('nid'=>12));?>">艺术欣赏</a></li>
                <li><a class="art" href="<?php echo U('Appreciate/index');?>">艺术鉴赏</a></li>
            </ul>
        </div>
    </div>
</div>
...
<div class="gallery-cursual">
    ...
    <div id="owl-demo" class="owl-carousel text-center">
        <?php if(is_array($center)): foreach($center as $key=>$v): ?><div class="item g1 popup-with-zoom-anim" href="#small-dialog">
            <img class="lazyOwl" data-src="/Public/Uploads/<?php echo ($v["icon"]); ?>" alt="name">
            <div class="caption">
    ...
    <!-- caption-popup -->
    <?php if(is_array($center)): foreach($center as $key=>$k): ?><div class="caption-popup">
        <div id="small-dialog" class="mfp-hide innercontent">
            <h4><?php echo ($k["title"]); ?></h4>
            <img class="img-responsive cap" src="/Public/Uploads/<?php echo ($k["icon"]); ?>" title="postname" />
            <p><?php echo ($k["introduce"]); ?></p>
...
<!-- /caption-popup -->
<!---pop-up-box---->
<link href="/Public/Index/css/popuo-box.css" rel="stylesheet" type="text/css" media="all"/>
<script src="/Public/Index/js/jquery.magnific-popup.js" type="text/javascript"></script>
...
<link rel="stylesheet" href="/Public/Index/css/swipebox.css">
<script src="/Public/Index/js/jquery.swipebox.min.js"></script>
<script type="text/javascript">
    jQuery(function($) {
        $(".swipebox").swipebox();
    });
...
<!-- Portfolio Ends Here -->
<script type="text/javascript" src="/Public/Index/js/jquery.mixitup.min.js"></script>
<script type="text/javascript">
    $(function () {
    ...
    <div class="container">
        <div class="add-top">
            ...
            <div class="col-md-2 add-right">
                <img src="/Public/Index/images/add.png" alt="" />
                <h3>Advertisement</h3>
            </div>
            <div class="clearfix"></div>
        </div>
