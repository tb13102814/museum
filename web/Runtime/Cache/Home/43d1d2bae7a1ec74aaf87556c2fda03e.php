    ...
    <div class="container">
        <div class="blog-top">
            <div class="col-md-9 blog-left">
                <div class="blog-main">
                    <a class="bg"><?php echo ($museum["title"]); ?></a>
                    <p>Post by <a href="#">Admin</a>&nbsp;&nbsp;&nbsp;&nbsp;20<?php echo (date('y-m-d',$museum["create_time"])); ?>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#">5 comments</a></p>
                </div>
                <div class="blog-main-one">
                    <div class="blog-one blog-sng">
                        <p class="sngl"><?php echo ($museum["introduce"]); ?></p></div>
